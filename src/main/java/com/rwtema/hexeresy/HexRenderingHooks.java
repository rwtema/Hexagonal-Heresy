...
//        faces.add(new Face(f001, f101, f111, f011, dxdz2, dz, dx2dz2, dydz)); //z+
	...
	public static class Face {
		...
		Face(float[] p0, float[] p1, float[] p2, float[] p3, float[] u0, float[] v0, float[] u1, float[] v1) {
			this.vecs = new float[][]{p0, p1, p2, p3};

			this.uvs = new float[][]{u0, v0, u1, v1};
		}

		TexturedQuad build(float x1, float y1, float z1, float x2, float y2, float z2, float texU, float texV, float dx, float dy, float dz, float w, float h) {
